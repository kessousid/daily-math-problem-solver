    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {"@type": "Answer", "text": "Yes, Maths Daily Helper is completely free to use."}
      },
      {
        "@type": "Question",
        "name": "Which grades does Maths Daily Helper cover?",
        "acceptedAnswer": {"@type": "Answer", "text": "It covers Grade 1 through Grade 12, plus IIT JEE, BITSAT, Math Olympiad, SAT, AMC 10/12, AIME, and more."}
      },
      {
        "@type": "Question",
        "name": "Does it support CBSE and ICSE?",
        "acceptedAnswer": {"@type": "Answer", "text": "Yes, Maths Daily Helper supports CBSE, ICSE, and many other boards including IB, Cambridge, and state boards."}
      },
      {
        "@type": "Question",
        "name": "How does Maths Daily Helper generate problems?",
        "acceptedAnswer": {"@type": "Answer", "text": "Problems are generated by Claude AI (Anthropic), tailored to your selected grade, topic, subtopic and difficulty level."}
      }
    ]
  }
]
